...
<div class="publication-entry">
    ...
    {% if publication.pdf %}[<a href="{{ publication.pdf }}">paper</a>]{% endif %} {% if publication.supp %}[<a href="{{ publication.supp }}">supp</a>]{% endif %} {% if publication.slides %}[<a href="{{ publication.slides }}">slides</a>]{% endif %} {% if publication.poster %}[<a href="{{ publication.poster }}">poster</a>]{% endif %} {% if publication.code %}[<a href="{{ publication.code }}">code</a>]{% endif %} {% if publication.video %}[<a href="{{ publication.video }}">video</a>]{% endif %}<br>
</div>
{% endif %}
{% endfor %}
