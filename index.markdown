...
<ul class="education-list">
  <li>
    <img src="{{ '/images/gatech-logo.png' | relative_url }}" alt="Georgia Tech" class="edu-logo" />
    <div class="edu-details">
      <span class="edu-degree">PhD in Electrical and Computer Engineering, 2026</span>
      <span class="edu-institution">Georgia Institute of Technology</span>
    </div>
  </li>
  <li>
    <img src="{{ '/images/gatech-logo.png' | relative_url }}" alt="Georgia Tech" class="edu-logo" />
    <div class="edu-details">
      <span class="edu-degree">MS in Electrical and Computer Engineering, 2020</span>
      <span class="edu-institution">Georgia Institute of Technology</span>
    </div>
  </li>
  <li>
    <img src="{{ '/images/nitt-logo.png' | relative_url }}" alt="NIT Trichy" class="edu-logo" />
    <div class="edu-details">
      <span class="edu-degree">B.Tech in Electronics and Communication Engineering, 2018</span>
      <span class="edu-institution">National Institute of Technology, Trichy</span>
    </div>
  </li>
</ul>
